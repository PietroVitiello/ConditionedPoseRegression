...
def get_keypoint_indices(img_size, coarse_factor=1):
    x = np.arange(img_size[0], step=coarse_factor, dtype=int)  # TODO should we have '+ 0.5' here?
    y = np.arange(img_size[1], step=coarse_factor, dtype=int)  # TODO should we have '+ 0.5' here?
