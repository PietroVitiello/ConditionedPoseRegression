...
class PointNet2_Encoder_v2(nn.Module):
    def __init__(self, output_dim, data_dim=0):
        ...
        self.sampled_points = nn.Parameter(torch.linspace(0,127,85,requires_grad=False))
    ...
    def forward(self, xyz):
        ...
        print(l2_xyz[:,:,self.sampled_points.to(dtype=int)].shape)
...
if __name__ == "__main__":
    pnet = PointNet2_Encoder_v2(256, 3)
