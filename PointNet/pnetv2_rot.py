...
class PointNetv2_RCl(nn.Module):

    def __init__(self, n_classes: int = 18) -> None:
        super(PointNetv2_RCl, self).__init__()
        ...
        self.initialise_pretrained("pnetv2_rot_9/version_0/checkpoints/last.ckpt")
        # self.initialise_pretrained("pnetv2_rot_7/version_0/checkpoints/last.ckpt")
