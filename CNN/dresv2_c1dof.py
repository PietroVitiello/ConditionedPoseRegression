...
from CNN.backbone_v2 import ResNet_Encoder, Single_ResNet_Block, ResNet_Block_0, ResNet_Block_2, ConvBlock

class DRes_v2_RCl(nn.Module):

    def __init__(self, n_classes: int = 18) -> None:
        super(DRes_v2_RCl, self).__init__()

        self.encoder = ResNet_Encoder()
        # self.fusion = Single_ResNet_Block(1024, 512)
        self.fusion = ConvBlock(1024, 512, downsample=False)
