...
from CNN.backbone import ResNet_Backbone_colvertex, ConvBlock, ResNet_Block_2

class DRNet_ColorVertexMap_Class(nn.Module):

    def __init__(self, n_classes: int = 18) -> None:
        super(DRNet_ColorVertexMap_Class, self).__init__()

        self.encoder = ResNet_Backbone_colvertex()
...
if __name__ == "__main__":
    ...
    model = DRNet_ColorVertexMap_Class()
